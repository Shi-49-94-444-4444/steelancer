            ...
            <div className="grid grid-cols-3 justify-between items-center">
                <div className="col-span-2">
                    ...
                    {projectStatus === "Complete" && (
                        <h2 className="font-bold">Project complete</h2>
                    )}
                    {projectStatus === "Close" && (
                        <h2 className="font-bold">Project closed</h2>
                    )}
                </div>
                <div className="col-span-1 pl-20">
                    ...
                    {projectStatus === "Complete" && (
                        <div className="text-[15px] p-2 bg-gray-400 rounded-full text-center text-blue-cus font-semibold">
                            Project complete
                        </div>
                    )}
                    {projectStatus === "Close" && (
                        <div className="text-[15px] p-2 bg-gray-cus rounded-full text-center text-blue-cus font-semibold">
                            Project Close
                        </div>
                    )}
                </div>
